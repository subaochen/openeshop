 ...
 This will deploy two artifacts, target/openeshop.war and
 default-ds.xml.
 ...
 Now you can either deploy the target/openeshop.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/openeshop.war

 To undeploy the application, run:

  ./asadmin undeploy openeshop
